...
namespace LogicManager
{
    ...
    void startCinematicAnimation(const std::string& animation_filename, const std::string& target_name, float speed, float lerp_time, bool is_static = false, const std::string& bone_name = "");
