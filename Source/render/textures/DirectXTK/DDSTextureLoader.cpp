...
namespace
{
    ...
    {
        PROFILE_FUNCTION("CreateD3DResources");
        if (!d3dDevice)
            return E_POINTER;
        ...
        case D3D11_RESOURCE_DIMENSION_TEXTURE2D:
        {
            ...
            {
              PROFILE_FUNCTION("CreateTexture2D");
